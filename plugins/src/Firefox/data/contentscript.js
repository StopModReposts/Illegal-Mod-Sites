...
if (smr_overlay_element == null && smr_illegal) { // Ensure that the overlay doesn't already exist
    ...
    document.getElementsByTagName("body")[0].appendChild(smr_overlay_element);
        ...
        document.getElementById("smr_warning_overlay_" + smr_tidoverlay).appendChild(smr_center_element);
            ...
            document.getElementById("smr_center_element_" + smr_tidoverlay).appendChild(smr_div_element);
                ...
                smr_title.textContent = "Site blacklisted by StopModReposts!";
                ...
                smr_explain.textContent = "This website is on a list of sites blacklisted by StopModReposts.org for illegal mod redistribution. This means the webpage you were about to visit right now is stealing mods from modders without permission in order to upload them here, is linking to outdated, incompatible or nonexistent versions of the mods, and/or is earning money off the modders\' hard work. You can still browse this page if you want to, but it is discouraged and may on some sites put your computer at risk of being infected by viruses and malware. ";
                document.getElementById("smr_div_element_" + smr_tidoverlay).appendChild(smr_explain);
                    ...
                    smr_explain_learnmore.textContent = "Click here to learn more about the StopModReposts campaign.";
                ...
                smr_rating_title.textContent = "Rating for " + location.host;
                ...
                document.getElementById("smr_div_element_" + smr_tidoverlay).appendChild(smr_rating_info_show);
                    ...
                    smr_rating_show_link.textContent = "Click here to learn about how we rate sites.";
                ...
                smr_rating_info.textContent = "Each site is given a rating from 1 to 5 in three categories: Advertising, redistribution and misleading information. Advertising indicates how many ads the site is displaying to mod downloaders (more money to the illegal site owner), redistribution indicates to what extent the site redistributes mods without permission, and misleading information indicates to what extent the site owner misleads users about the posted mods (e.g. outdated, incompatible or nonexistent mod versions and whether the author is credited). A lower score is better, with 1 star being the best score. ";
                document.getElementById("smr_div_element_" + smr_tidoverlay).appendChild(smr_rating_info);
                    ...
                    smr_rating_hide_link.textContent = "(Click to hide)";
                ...
                document.getElementById("smr_div_element_" + smr_tidoverlay).appendChild(smr_rating_table);
                    ...
                    document.getElementById("smr_rating_table_" + smr_tidoverlay).appendChild(smr_rating_tbody);
                        ...
                        document.getElementById("smr_rating_tbody_" + smr_tidoverlay).appendChild(smr_rating_row1);
                            ...
                            smr_rating_r1c1.textContent = "Category";
                            ...
                            smr_rating_r1c2.textContent = "Evilness rating";
                            ...
                            smr_rating_r1c3.textContent = "Rating level";
    ...
    if (smr_this_rating.length > 3) {
                ...
                smr_rating_notes.textContent = "Notes for this site: " + smr_this_rating.substring(3);
                            ...
                            document.getElementById("smr_btn_row_" + smr_tidoverlay).appendChild(smr_btn_close_cell);
                                ...
                                document.getElementById("smr_warning_close_" + smr_tidoverlay).appendChild(smr_overlay_close);
                                    ...
                                    document.getElementById("smr_overlay_close_" + smr_tidoverlay).appendChild(smr_close_div);
                                        ...
                                        smr_close_div_b.textContent = "Return to previous page";
                                        ...
                                        smr_close_div_span.textContent = "(recommended for your safety)";
                            ...
                            document.getElementById("smr_btn_row_" + smr_tidoverlay).appendChild(smr_btn_continue_cell);
                                ...
                                document.getElementById("smr_warning_continue_" + smr_tidoverlay).appendChild(smr_overlay_continue);
                                    ...
                                    document.getElementById("smr_overlay_continue_" + smr_tidoverlay).appendChild(smr_continue_div);
                                        ...
                                        smr_continue_div_b.textContent = "Continue to the site";
                                        ...
                                        smr_continue_div_span.textContent = "(may harm your computer)";
